...
```javascript
import isReadWritePropertyIn from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-read-write-property-in@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-read-write-property-in/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/assert-is-read-write-property-in/actions/workflows/test.yml?query=branch:v0.2.1
